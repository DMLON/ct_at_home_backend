...
class ContainerKnexDB implements IDBConnector{
    knex: any;
    table: any;
...
class DBTester{
    ...
    async test_insert(){
        ...
        const db = new ContainerKnexDB(this.table,options);
    
        
    
        let res = await db.createObject(this.test_obj);
        console.log(res);
        db.destroy();
        return res;
    }
...
export default ContainerKnexDB;